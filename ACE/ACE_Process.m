...
if ~all(cseq.channels >= 0) | ~all(cseq.channels <= 30)
...
%q.periods			= 125;			    % Copy periods.% for plotting electrodogram
q.periods = 1/p.StimulationRate/p.Nmaxima*1000000;  % 20171001 modified by Qinglin to get correct plot x axis   。 1000000的含义我也没搞懂
