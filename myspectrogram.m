...
% 20190826 Qinglin Modified the T at line 169
% T = [0:M-1]* Z/fs;  % 2019/8/26 改为这个
...
ylabel('frequency (kHz)', 'FontSize', 13, 'FontWeight', 'n');
...
set(gca,'YTick',0:1000:8000,'YTickLabel',0:8)
